...
import com.legoaggelos.calculating.Calculator;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String valueFromCommand = calc.getValueFromCommand(command, trigType, lastValue).trim();
            ...
            try {
                lastValue = Double.parseDouble(valueFromCommand);
